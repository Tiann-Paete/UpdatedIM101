  ...
  return (
    ...
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center">
      ...
      <section className="bg-cover bg-center min-h-screen flex flex-col items-center justify-center px-6 py-8" style={{ backgroundImage: "url('/images/narsadmin.jpg')" }}>
        <div className="w-full max-w-md bg-neutral-800 rounded-lg shadow-md p-6 dark:bg-gray-400 dark:border dark:border-gray-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-8" action="#">
            <div>
              ...
              <div className="flex">
                ...
                <input type="text" id="username" name="username" className="rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 flex-1 min-w-0 p-2.5 dark:bg-gray-700 dark:text-white outline-orange-300" placeholder="Username" required />
              </div>
            </div>
            <div className="relative mt-4">
              ...
              <div className="flex">
                ...
                <input type={showPassword ? 'text' : 'password'} id="password" name="password" className="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:border-primary-600 flex-1 min-w-0 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white outline-orange-300" placeholder="Password" required />
